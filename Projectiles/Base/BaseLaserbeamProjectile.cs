...
{
    internal abstract class BaseLaserbeamProjectile : ModProjectile
    {
        ...
        public virtual void Behavior()
        {
            ...
            LaserLength = HoloMathHelper.Lerp(LaserLength, idealLaserLength, 0.9f); // Very quickly approach the ideal laser length.
        ...
        public virtual void UpdateLaserMotion()
        {
            ...
            Projectile.rotation = updatedVelocityDirection - HoloMathHelper.PiOver2; // Pretty much all lasers have a vertical sheet.
        ...
        {
            Projectile.scale = HoloMathHelper.Sin(Time / Lifetime * HoloMathHelper.Pi) * ScaleExpandRate * MaxScale;
