using HololiveMod.Items.Accessories;
...
namespace HololiveMod.Systems
{
    internal class ModIntegrationsSystem : ModSystem
    {
        ...
        private void DoBossChecklistIntegration()
        {
            ...
            string internalName = "AmeliaWatson";
            ...
            int bossType = ModContent.NPCType<NPC.Bosses.AmeliaWatson>();

            // The item used to summon the boss with (if available)
            int spawnItem = ModContent.ItemType<DetectiveScope>();

            // "collectibles" like relic, trophy, mask, pet
            List<int> collectibles = new List<int>()
            {
                ModContent.ItemType<PhoenixShield>(),
            };
            ...
            {
                Texture2D texture = ModContent.Request<Texture2D>("HololiveMod/NPC/Bosses/AmeliaWatsonPhase1").Value;
